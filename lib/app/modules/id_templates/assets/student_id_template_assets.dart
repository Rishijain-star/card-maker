/// Portrait student ID — background PNGs (form text overlaid on top).
abstract final class StudentIdTemplateAssets {
  static const String frontBackground =
      'assets/ChatGPT Image Jun 4, 2026, 03_15_17 PM.png';
  static const String backBackground =
      'assets/ChatGPT Image Jun 4, 2026, 03_26_42 PM.png';
  static const String frontBackgroundV2 = 'assets/secound etmplat.png';
  static const String backBackgroundV2 =
      'assets/ChatGPT Image Jun 4, 2026, 05_06_29 PM.png';
  static const String frontBackgroundV3 = 'assets/3rd tempolate front.png';
  ...
  static const String frontBackgroundV7 = 'assets/7th front.png';
  static const String backBackgroundV7 = 'assets/7th back.png';
  static const String frontBackgroundV8 = 'assets/8th front.png';
  static const String backBackgroundV8 = 'assets/8th back.png';
  static const String frontBackgroundV9 = 'assets/9th front.png';
  static const String backBackgroundV9 = 'assets/9thback.png';
  static const String frontBackgroundV10 = 'assets/10 front.png';
  ...
  static const List<String> frontBackgrounds = <String>[
    'assets/ChatGPT Image Jun 4, 2026, 03_15_17 PM.png', // 1
    ...
    'assets/sisxth frotn comapny.png',                    // 20
    'assets/student_comp_7_front.png',                    // 21
    'assets/complamy template 8.png',                     // 22
    'assets/student_9_front.png',                         // 23
    'assets/10th front company.png',                      // 24
    'assets/11th company frotn.png',                      // 25
    'assets/26 th front.png',                             // 26
    'assets/27 front.png',                                // 27
    'assets/templatenumber 28.png',                       // 28
    'assets/templatenumber29.png',                        // 29
    'assets/30th front.png',                              // 30
    'assets/31th froint.png',                             // 31
    'assets/template_32_front.png',                       // 32
    'assets/33front.png',                                 // 33
    'assets/34front.png',                                 // 34
    'assets/35front.png',                                 // 35
    'assets/template number 36.png',                      // 36
  ...
  static const List<String> backBackgrounds = <String>[
    'assets/ChatGPT Image Jun 4, 2026, 03_26_42 PM.png', // 1
    'assets/ChatGPT Image Jun 4, 2026, 05_06_29 PM.png', // 2
    'assets/3rd back.png',                                // 3
    'assets/4th template back.png',                       // 4
    'assets/5th tempate back.png',                        // 5
    'assets/6th back.png',                                // 6
    'assets/7th back.png',                                // 7
    'assets/8th back.png',                                // 8
    ...
    'assets/sixsth back company.png',                     // 20
    'assets/7th back company.png',                        // 21
    'assets/8th backl company.png',                       // 22
    'assets/9th backed company.png',                      // 23
    'assets/10th back companyu.png',                      // 24
    'assets/11th company bacl.png',                       // 25
    'assets/26th back .png',                              // 26
    'assets/27 back .png',                                // 27
    'assets/28th back .png',                              // 28
    'assets/templatenumber29.png',                        // 29
    'assets/30th back .png',                              // 30
    'assets/31th back .png',                              // 31
    'assets/32th back .png',                              // 32
    'assets/33back.png',                                  // 33
    'assets/34back.png',                                  // 34
    'assets/35back.png',                                  // 35
    'assets/36 back.png',                                 // 36
  ...
  static String getFrontAsset(int index) {
    if (index < 0 || index >= frontBackgrounds.length) {
      return frontBackgrounds[0];
    }
    return frontBackgrounds[index];
  }

  static String getBackAsset(int index) {
    if (index < 0 || index >= backBackgrounds.length) {
      return backBackgrounds[0];
    }
    return backBackgrounds[index];
  }
}
