...
class StudentIdTemplatePortraitV2 extends StatelessWidget {
  ...
  /// Shrink on one line; allow 2nd line only for unusually long names.
    ...
    return Stack(
      ...
      children: [
        ...
        if (data.hasSignature)
          Positioned(
            right:  _w * _PortraitV2Layout.frontSignatureRightRatio,
            bottom: _h * _PortraitV2Layout.frontSignatureBottomRatio,
            child: StudentPortraitSignatureCircle(
              size: _w * _PortraitV2Layout.frontSignatureSizeRatio,
