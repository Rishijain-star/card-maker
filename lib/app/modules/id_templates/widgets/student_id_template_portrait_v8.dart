    ...
    return Stack(
      ...
      children: [
        ...
        if (data.hasSignature)
          Positioned(
            right: _w * _PortraitV8Layout.frontSignatureRightRatio,
            bottom: _h * _PortraitV8Layout.frontSignatureBottomRatio,
            child: StudentPortraitSignatureCircle(
              size: _w * _PortraitV8Layout.frontSignatureSizeRatio,
