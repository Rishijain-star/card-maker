    ...
    return Stack(
      ...
      children: [
        ...
        if (data.hasSignature)
          Positioned(
            right: _w * _PortraitV13Layout.signatureRightRatio,
            bottom: _h * _PortraitV13Layout.signatureBottomRatio,
            child: StudentPortraitSignatureCircle(
              size: _w * _PortraitV13Layout.signatureSizeRatio,
