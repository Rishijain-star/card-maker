    ...
    return Stack(
      ...
      children: [
        ...
        if (data.hasSignature)
          Positioned(
            right: _w * _PortraitV6Layout.frontSignatureRightRatio,
            bottom: _h * _PortraitV6Layout.frontSignatureBottomRatio,
            child: StudentPortraitSignatureCircle(
              size: _w * _PortraitV6Layout.frontSignatureSizeRatio,
